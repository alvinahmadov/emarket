...
export const environment: Environment = {
	...
	FAKE_MERCHANT_NAME: "${env.FAKE_MERCHANT_NAME}";
	FAKE_MERCHANT_PASSWORD: "${env.FAKE_MERCHANT_PASSWORD}";
	FAKE_MERCHANT_EMAIL: "${env.FAKE_MERCHANT_EMAIL}";
	...
	WAREHOUSE_PASSWORD_BCRYPT_SALT_ROUNDS: ${env.WAREHOUSE_PASSWORD_BCRYPT_SALT_ROUNDS},
