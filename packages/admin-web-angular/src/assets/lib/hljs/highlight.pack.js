...
!(function (e) {
	...
	function i(e) {
		var n,
			...
			o = e.className + ' ';
		if (
			((o += e.parentNode ? e.parentNode.className : ''), (t = M.exec(o)))
		)
